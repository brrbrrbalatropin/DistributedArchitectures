...
public final class RecreationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest,
      edu.eci.arsw.microservices.ResourceList> getGetResourcesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetResources",
      requestType = edu.eci.arsw.microservices.EmptyRequest.class,
      responseType = edu.eci.arsw.microservices.ResourceList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest,
      edu.eci.arsw.microservices.ResourceList> getGetResourcesMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest, edu.eci.arsw.microservices.ResourceList> getGetResourcesMethod;
      ...
      synchronized (RecreationServiceGrpc.class) {
        if ((getGetResourcesMethod = RecreationServiceGrpc.getGetResourcesMethod) == null) {
          RecreationServiceGrpc.getGetResourcesMethod = getGetResourcesMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.microservices.EmptyRequest, edu.eci.arsw.microservices.ResourceList>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.ResourceList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.microservices.ReservationRequest,
      edu.eci.arsw.microservices.ReservationResponse> getReserveResourceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReserveResource",
      requestType = edu.eci.arsw.microservices.ReservationRequest.class,
      responseType = edu.eci.arsw.microservices.ReservationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.microservices.ReservationRequest,
      edu.eci.arsw.microservices.ReservationResponse> getReserveResourceMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.microservices.ReservationRequest, edu.eci.arsw.microservices.ReservationResponse> getReserveResourceMethod;
      ...
      synchronized (RecreationServiceGrpc.class) {
        if ((getReserveResourceMethod = RecreationServiceGrpc.getReserveResourceMethod) == null) {
          RecreationServiceGrpc.getReserveResourceMethod = getReserveResourceMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.microservices.ReservationRequest, edu.eci.arsw.microservices.ReservationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReserveResource"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.ReservationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.ReservationResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getResources(edu.eci.arsw.microservices.EmptyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ResourceList> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetResourcesMethod(), responseObserver);
    }

    /**
     */
    default void reserveResource(edu.eci.arsw.microservices.ReservationRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ReservationResponse> responseObserver) {
  ...
  public static final class RecreationServiceStub
    ...
    /**
     */
    public void getResources(edu.eci.arsw.microservices.EmptyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ResourceList> responseObserver) {
    ...
    /**
     */
    public void reserveResource(edu.eci.arsw.microservices.ReservationRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ReservationResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class RecreationServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.microservices.ResourceList getResources(edu.eci.arsw.microservices.EmptyRequest request) {
    ...
    /**
     */
    public edu.eci.arsw.microservices.ReservationResponse reserveResource(edu.eci.arsw.microservices.ReservationRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RecreationServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.microservices.ResourceList> getResources(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.microservices.ReservationResponse> reserveResource(
        edu.eci.arsw.microservices.ReservationRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_RESOURCES:
          serviceImpl.getResources((edu.eci.arsw.microservices.EmptyRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ResourceList>) responseObserver);
          break;
        case METHODID_RESERVE_RESOURCE:
          serviceImpl.reserveResource((edu.eci.arsw.microservices.ReservationRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.ReservationResponse>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              edu.eci.arsw.microservices.ResourceList>(
                service, METHODID_GET_RESOURCES)))
        .addMethod(
          getReserveResourceMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.microservices.ReservationRequest,
              edu.eci.arsw.microservices.ReservationResponse>(
  ...
  private static abstract class RecreationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.eci.arsw.microservices.RecreationProto.getDescriptor();
    }
