...
public final class MedicalServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest,
      edu.eci.arsw.microservices.SpecialtyList> getGetSpecialtiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSpecialties",
      requestType = edu.eci.arsw.microservices.EmptyRequest.class,
      responseType = edu.eci.arsw.microservices.SpecialtyList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest,
      edu.eci.arsw.microservices.SpecialtyList> getGetSpecialtiesMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.microservices.EmptyRequest, edu.eci.arsw.microservices.SpecialtyList> getGetSpecialtiesMethod;
      ...
      synchronized (MedicalServiceGrpc.class) {
        if ((getGetSpecialtiesMethod = MedicalServiceGrpc.getGetSpecialtiesMethod) == null) {
          MedicalServiceGrpc.getGetSpecialtiesMethod = getGetSpecialtiesMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.microservices.EmptyRequest, edu.eci.arsw.microservices.SpecialtyList>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.SpecialtyList.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<edu.eci.arsw.microservices.SpecialtyRequest,
      edu.eci.arsw.microservices.SpecialtyResponse> getGetSpecialtyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSpecialty",
      requestType = edu.eci.arsw.microservices.SpecialtyRequest.class,
      responseType = edu.eci.arsw.microservices.SpecialtyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.eci.arsw.microservices.SpecialtyRequest,
      edu.eci.arsw.microservices.SpecialtyResponse> getGetSpecialtyMethod() {
    io.grpc.MethodDescriptor<edu.eci.arsw.microservices.SpecialtyRequest, edu.eci.arsw.microservices.SpecialtyResponse> getGetSpecialtyMethod;
      ...
      synchronized (MedicalServiceGrpc.class) {
        if ((getGetSpecialtyMethod = MedicalServiceGrpc.getGetSpecialtyMethod) == null) {
          MedicalServiceGrpc.getGetSpecialtyMethod = getGetSpecialtyMethod =
              io.grpc.MethodDescriptor.<edu.eci.arsw.microservices.SpecialtyRequest, edu.eci.arsw.microservices.SpecialtyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSpecialty"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.SpecialtyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.eci.arsw.microservices.SpecialtyResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void getSpecialties(edu.eci.arsw.microservices.EmptyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyList> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetSpecialtiesMethod(), responseObserver);
    }

    /**
     */
    default void getSpecialty(edu.eci.arsw.microservices.SpecialtyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyResponse> responseObserver) {
  ...
  public static final class MedicalServiceStub
    ...
    /**
     */
    public void getSpecialties(edu.eci.arsw.microservices.EmptyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyList> responseObserver) {
    ...
    /**
     */
    public void getSpecialty(edu.eci.arsw.microservices.SpecialtyRequest request,
        io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class MedicalServiceBlockingStub
    ...
    /**
     */
    public edu.eci.arsw.microservices.SpecialtyList getSpecialties(edu.eci.arsw.microservices.EmptyRequest request) {
    ...
    /**
     */
    public edu.eci.arsw.microservices.SpecialtyResponse getSpecialty(edu.eci.arsw.microservices.SpecialtyRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class MedicalServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.microservices.SpecialtyList> getSpecialties(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.eci.arsw.microservices.SpecialtyResponse> getSpecialty(
        edu.eci.arsw.microservices.SpecialtyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SPECIALTIES:
          serviceImpl.getSpecialties((edu.eci.arsw.microservices.EmptyRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyList>) responseObserver);
          break;
        case METHODID_GET_SPECIALTY:
          serviceImpl.getSpecialty((edu.eci.arsw.microservices.SpecialtyRequest) request,
              (io.grpc.stub.StreamObserver<edu.eci.arsw.microservices.SpecialtyResponse>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              edu.eci.arsw.microservices.SpecialtyList>(
                service, METHODID_GET_SPECIALTIES)))
        .addMethod(
          getGetSpecialtyMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              edu.eci.arsw.microservices.SpecialtyRequest,
              edu.eci.arsw.microservices.SpecialtyResponse>(
  ...
  private static abstract class MedicalServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.eci.arsw.microservices.MedicalProto.getDescriptor();
    }
